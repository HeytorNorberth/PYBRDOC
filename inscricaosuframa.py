...
class InscricaoSuframa(DocumentoIdentificacao):
	"""
	docstring for Número de inscrição na Superintendência da Zona Franca de Manaus (SUFRAMA)
...
class ValidadorSuframa(object):
	...
	def __validarInscricaoSuframa(self, arg): 
		return self.__validarStr(arg.rawValue)
	"""
	Attributes
	----------

	# type: (InscricaoSuframa) -> bool
	...
	def __hashDigit(self, num, position): 
		"""
		Attributes
		----------
		...
		Return
		str
		retorna 0 se o valor for menor que 2, se não, retorna 11 - valor 
