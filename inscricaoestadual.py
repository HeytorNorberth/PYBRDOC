...
class InscricaoEstadual(DocumentoIdentificacao):
	...
	Methods
	-------
	cada if tem a igualdade com a sigla que representa cada estado, para fazer tratamento adequado do numero e retornar o valor bruto

	Returns
	-------
	retorna o Rawvalue do numero tratado

	"""
	def __init__(self, arg, siglaUF): 
...
class ValidadorInscricaoEstadual(object):
	...
	Methods
	-------
	função para validar a IE e a string passada com a UF
