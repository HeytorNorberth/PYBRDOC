...
Adicionado a função consultar CNPJ, que por meio de uma API da receita federal "ReceitaWS", consegue informar os dados sobre o CNPJ desejado, retorna NOME,DATA DE ABERTURA,CONTATO,ONDE FICA LOCALIZADO, PORTE DA EMPRESA SE ESTÁ ATIVA OU NÃO,NATUREZA JURÍDICA,QUAL CATEGORIA DE EMPRESA ELA SE ENCAIXA.

EXEMPLO ABAIXO DEMONSTRA A UTILIZAÇÃO DESSA FUNÇÃO, USANDO O CNPJ DO (CRUZEIRO ESPORTE CLUBE-SAF)

#### Utilização

	>>> validar_cnpj.consulta_cnpj('44490706000154')
    Nome: CRUZEIRO ESPORTE CLUBE - SOCIEDADE ANONIMA DO FUTEBOL
    Data de abertura: 06/12/2021
    Empresa: DEMAIS
    Situação atual: ATIVA
    Faz isso: [{'text': 'Clubes sociais, esportivos e similares', 'code': '93.12-3-00'}]
    Natureza Juridica: 205-4 - Sociedade Anônima Fechada
    Onde fica: BELO HORIZONTE
    Contato: (31) 3995-5005
