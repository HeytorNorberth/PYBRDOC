...
class ValidadorCnpj(object):
	...
	def validar(arg): 
		...
		# type: (CNPJ) -> bool or  type: (str) -> bool
	...
	def consulta_cnpj(self,cnpj):
		...
		Funcao que acessa uma API por meio da url, com isso, ela recebe o cnpj que for passado e vai buscar online 
		retornando o alguns dados que são requeridos, como data de abertura, nome,atividade principal da empresa
